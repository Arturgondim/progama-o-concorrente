...
public class RedTrain extends Thread{
    ...
    public RedTrain(ImageView trainImage, int position, Slider slider, int solution) {
    ...
    /****************************************************************
     * Metodo: run
     * Funcao: define o que a thread vai controlar  o movimento do trem vermelho
     * Parametros:void
     * Retorno: void
     ****************************************************************/
    @Override
    ...
    public void move(){
        switch (position) {
            case 1: {
              ...
              if (this.getTrainImage().getLayoutX() <= 106 && this.getTrainImage().getLayoutX() > -33) {
              this.getTrainImage().setLayoutX(this.getTrainImage().getLayoutX() + this.getSpeedX());
              } // fim do primeiro if

              else if (this.getTrainImage().getLayoutX() <= 176 && this.getTrainImage().getLayoutX() >= 106) {
              if( !entracz1(solution) && !cz1) {
                    break;
              }
              this.getTrainImage().setRotate(305);
              ...
              else if (this.getTrainImage().getLayoutX() <= 367 && this.getTrainImage().getLayoutX() >= 176) {
              this.getTrainImage().setRotate(0);
              this.getTrainImage().setLayoutX(this.getTrainImage().getLayoutX() + this.getSpeedX());
              } // fim do terceiro if

              else if (this.getTrainImage().getLayoutX() <= 437 && this.getTrainImage().getLayoutX() >= 367) {
              this.getTrainImage().setRotate(45);
              this.getTrainImage().setLayoutY(this.getTrainImage().getLayoutY()  + this.getSpeedY());
              this.getTrainImage().setLayoutX(this.getTrainImage().getLayoutX()  + this.getSpeedX()/2); 
              } // fim do quarto if

              else if (this.getTrainImage().getLayoutX() <= 654 && this.getTrainImage().getLayoutX() >= 437) {
              saicz1(solution);
              this.getTrainImage().setRotate(0);
              this.getTrainImage().setLayoutX(this.getTrainImage().getLayoutX() + this.getSpeedX());
              } // fim do quinto if

              else if (this.getTrainImage().getLayoutX() <= 724 && this.getTrainImage().getLayoutX() >= 654) {
              ...
              else if (this.getTrainImage().getLayoutX() <= 916 && this.getTrainImage().getLayoutX() >= 724) {
              this.getTrainImage().setRotate(0);
              this.getTrainImage().setLayoutX(this.getTrainImage().getLayoutX() + this.getSpeedX());
              } // fim do setimo if

              else if (this.getTrainImage().getLayoutX() <= 986 && this.getTrainImage().getLayoutX() >= 916) {
              this.getTrainImage().setRotate(45);
              this.getTrainImage().setLayoutY(this.getTrainImage().getLayoutY() + this.getSpeedY());
              this.getTrainImage().setLayoutX(this.getTrainImage().getLayoutX() + this.getSpeedX()/2); 
              } // fim do oitavo if

              else if (this.getTrainImage().getLayoutX() <= 1250 && this.getTrainImage().getLayoutX() >= 986) {
              saicz2(solution);
              this.getTrainImage().setRotate(0);
              this.getTrainImage().setLayoutX(this.getTrainImage().getLayoutX() + this.getSpeedX());
              } // fim do nono if
              ...
              this.getTrainImage().setLayoutY(375);
              this.getTrainImage().setRotate(0);
            ...
            case 3:{
               ...
               else if (this.getTrainImage().getLayoutX() <= 715 && this.getTrainImage().getLayoutX() >= 650) {
               this.getTrainImage().setRotate(305);
               this.getTrainImage().setLayoutY(this.getTrainImage().getLayoutY() + this.getSpeedY());
               this.getTrainImage().setLayoutX(this.getTrainImage().getLayoutX() - this.getSpeedX()/2); 
               } // fim do quarto if

               else if (this.getTrainImage().getLayoutX() <= 650 && this.getTrainImage().getLayoutX() >= 460) {
               saicz2(solution);
               this.getTrainImage().setRotate(0);
               this.getTrainImage().setLayoutX(this.getTrainImage().getLayoutX() - this.getSpeedX());
               } // fim do quinto if

               else if (this.getTrainImage().getLayoutX() <= 460 && this.getTrainImage().getLayoutX() >= 390) {
               if( !entracz1(solution) && !cz1) {
                break;
               }
               this.getTrainImage().setRotate(45);
               ...
               else if (this.getTrainImage().getLayoutX() <= 390 && this.getTrainImage().getLayoutX() >= 177) {
               this.getTrainImage().setRotate(0);
               this.getTrainImage().setLayoutX(this.getTrainImage().getLayoutX() - this.getSpeedX());
               } // fim do setimo if

               else if (this.getTrainImage().getLayoutX() <= 177 && this.getTrainImage().getLayoutX() >= 107) {
               this.getTrainImage().setRotate(305);
               this.getTrainImage().setLayoutY(this.getTrainImage().getLayoutY() + this.getSpeedY());
               this.getTrainImage().setLayoutX(this.getTrainImage().getLayoutX() - this.getSpeedX()/2); 
               } // fim do oitavo if
               ...
               this.getTrainImage().setLayoutY(383);
               this.getTrainImage().setRotate(0);
               } // voltando para a posicao inicial
               break;
    }
