...
/* ***************************************************************
* Classe principal estende Aplication, classe necessaria para a 
construção da GUI
*************************************************************** */
...
public class Principal extends Application{
    ...
    ******************************************************************/
    ...
    public void start(Stage stage) throws IOException{
        stage.getIcons().add(new Image("./img./train-icon.png"));/*adiciona um icone a cena*/
        stage.setTitle("Train Simulator");/*define um titulo a cena*/

        Parent root = FXMLLoader.load(getClass().getResource("view/homeController.fxml"));/*define o caminho que ira aparecer ao criar a cena */
        ...
        stage.setOnCloseRequest(e -> System.exit(0));// mostra o stage
